...
<div class="col d-flex justify-content-center">
    <aside class="col-sm-6">
        ...
        <article class="card-body">
            ...
            <div class="form-group">
            <div class="input-group">
                <label for="EquipmentType" class="col-sm-4 col-form-label">Asset Type</label>
            ...
            <div class="form-group">
             <div class="input-group">
                <label for="Price" class="col-sm-4 col-form-label">Price(Nu.)</label>
            ...
            <div class="form-group">
            <div class="input-group">
                <label for="image" class="col-sm-4 col-form-label">Image asset</label>
