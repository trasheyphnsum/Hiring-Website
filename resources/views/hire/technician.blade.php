...
<div class="col d-flex justify-content-center">
    <aside class="col-sm-5">
        ...
        <article class="card-body">
            ...
            <div class="form-group">
            <div class="input-group">
                <label for="technician" class="col-sm-3 col-form-label">Technician Type(Expertise) </label>
            ...
            <div class="form-group">
            <div class="input-group">
                <label for="certificate" class="col-sm-3 col-form-label">Relevant Certificate</label>
